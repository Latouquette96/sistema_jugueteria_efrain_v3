...
class CatalogDistributorProvider extends CatalogPlutonizableStateNotifier<Distributor> {
  //Atributos de clase
...
///catalogDistributorProvider es un proveedor que almacena la lista de distribuidoras.
final catalogDistributorProvider = StateNotifierProvider<CatalogDistributorProvider, List<Distributor>>((ref) => CatalogDistributorProvider(ref, stateManagerDistributorProvider));