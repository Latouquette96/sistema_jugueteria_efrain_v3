...
class StateManagerDistributorMySQL extends StateManager<Distributor>{
  //Atributos de clases
  static final StateManagerDistributorMySQL _instance = StateManagerDistributorMySQL._(path: "/distributors");
