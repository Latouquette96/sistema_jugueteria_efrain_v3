...
class StateManagerProductMySQL extends StateManager<Product>{
  //Atributos de clases
  static final StateManagerProductMySQL _instance = StateManagerProductMySQL._(path: "/products");
  ...
  Future<ResponseAPI> update(String url, Product element) async {
    ...
    if (responseAPI.isResponseSuccess()){
      ...
      StateManagerProductMySQL.getInstance().getStateManager()!.setShowLoading(true);

      Future.delayed(const Duration(milliseconds: 500), () {
        element.updatePlutoRow();
        StateManagerProductMySQL.getInstance().getStateManager()!.setShowLoading(false);
      });
